...
bool LEDSerialPort::open(const char* portname,
	int baudrate,
	char parity,
	char databit,
	char stopbit,
...
void LEDSerialPort::close()
{
	HANDLE hCom = *(HANDLE*)pHandle;
	CloseHandle(hCom);
}

int LEDSerialPort::send(string dat)
{
	HANDLE hCom = *(HANDLE*)pHandle;
